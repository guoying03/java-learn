...
/**
 * @ClassName Test2
 * @Description LocalDateTest2类练习（er）
 * @Author GYY
 * @Date 2020/10/30
 **/
public class LocalDateTest2 {
    ...
    public static void checkCardExpiry() {
        ...
        YearMonth creditCarExpiry = YearMonth.of (2028, Month.FEBRUARY);
        System.out.printf("Your credit card expires on %s %n", creditCarExpiry);
    }
    /**
     * 检查闰年
     */
    ...
    public static void calcDateDays() {
        ...
        System.out.println("Months left between today and Java 8 relase :" + periodToNextJavaRelease.getMonths());
